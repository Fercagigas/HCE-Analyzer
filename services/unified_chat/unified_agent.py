...
"""
    ...
    def process_message(
        ...
        Args:
            ...
            patient_id/encounter_id/purpose: contexto de scope (WP5). El bucle legacy aun no
                lo aplica; el ChatService de WP8 lo convierte en RequestContext obligatorio.
