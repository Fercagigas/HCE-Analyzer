...
La inteligencia artificial (\acs{IA}) ha experimentado una transformación radical en la última década, impulsada fundamentalmente por el desarrollo de los modelos de lenguaje de gran escala (\textit{Large Language Models}, \acs{LLM}s). Desde los sistemas expertos clásicos como MYCIN \cite{shortliffe1976} e INTERNIST-I \cite{miller1982}, que operaban mediante reglas de producción codificadas manualmente, hasta los actuales modelos basados en la arquitectura Transformer \cite{vaswani2017attention}, el campo ha evolucionado hacia sistemas capaces de procesar lenguaje natural con un nivel de sofisticación sin precedentes.
