...
\node[toolnode]  (db)  at (-4.2,-6.5) {Database Tool\\$f_\text{DB}$};
\node[toolnode]  (rag) at ( 0.0,-6.5) {RAG Tool\\$f_\text{RAG}$};
\node[toolnode]  (viz) at ( 4.2,-6.5) {Visualization Tool\\$f_\text{VIZ}$};
...
\node[latency] at (6.35, -6.5)  {P50: $\sim$1.5\,s / $\sim$2\,s / $\sim$3\,s};
\node[latency] at (6.35, -8.5)  {P50: $\sim$1\,s};
\node[latency] at (6.35, -10.0) {Total P50: $<$5\,s};
