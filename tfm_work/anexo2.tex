...
Se utiliza el mismo modelo (Claude Haiku~4.5) como sistema evaluado y como evaluador \ac{RAGAS}. Esto introduce un sesgo potencial: el evaluador puede ser más tolerante con el estilo de respuesta y las formulaciones del sistema evaluado al compartir patrones lingüísticos y razonamiento~\cite{Zheng2023llmjudge}. La literatura sobre evaluación \ac{LLM}-as-a-Judge sugiere que modelos más capaces (como \acs{GPT}-4 o Claude 3 Opus) como evaluadores proporcionan mayor discriminación~\cite{Yu2025agentjudge}, pero el coste de ejecución sería significativamente superior al presupuesto disponible para la evaluación.
