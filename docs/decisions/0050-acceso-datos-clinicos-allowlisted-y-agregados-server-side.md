...
El usuario confirmo expresamente la opcion A: eliminar SQL libre por completo, tambien en
investigacion MIMIC. No existe flag, modo avanzado ni ruta de escape que permita al modelo
formular consultas SQL.
