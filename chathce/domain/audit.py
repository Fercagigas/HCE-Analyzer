...
class AuditAction(str, Enum):
    ...
    ai_kill_switch_changed = "ai_kill_switch_changed"
    ai_kill_switch_rejected = "ai_kill_switch_rejected"
    tool_call = "tool_call"
    tool_refused = "tool_refused"
    tool_failed = "tool_failed"
    clinical_query = "clinical_query"
    knowledge_query = "knowledge_query"
    knowledge_document_drafted = "knowledge_document_drafted"
    knowledge_document_approved = "knowledge_document_approved"
    knowledge_document_retired = "knowledge_document_retired"
