...
| P0.2 Evidence object | ✅ | `Evidence` con id, tipo, sistema origen, recurso, paciente/episodio, timestamp, valor/unidades y provenance; para RAG incluye versión, estado y vigencia documental |
